...
namespace Oxide.Plugins
{
    ...
    public class SimplePrefabEditor : RustPlugin
    {
        ...
        private readonly (string shortname, float weight)[] DefaultGunPool =
        {
            ...
            ("pistol.m92",              1f),
            ("pistol.semiauto",         1f),
            ("pistol.semiauto.a.m15",   1f),
            ("pistol.prototype17",      1f),
            ("pistol.python",           1f),
            ("pistol.nailgun",          1f),
            ("pistol.revolver",         1f),
            ("rifle.ak",                1f),
            ...
            ("t1_smg",                  1f),
            ("rocket.launcher",         1f),
            ("rocket.launcher.rpg7",    1f),
            ("grenade.f1",              1f),
            ("multiplegrenadelauncher", 1f),
            ("grenade.molotov",         1f),
            ("pistol.water",            1f),
        };
        ...
        private class PluginConfig
        {
            ...
            {
                ["smg.mp5"]                 = "https://via.placeholder.com/256x256.png?text=MP5",
                ...
                ["hmlmg"]                   = "https://via.placeholder.com/256x256.png?text=HMLMG",
                ["minigun"]                 = "https://via.placeholder.com/256x256.png?text=Minigun",
                ["pistol.eoka"]             = "https://via.placeholder.com/256x256.png?text=Eoka",
                ["pistol.m92"]              = "https://via.placeholder.com/256x256.png?text=M92",
                ["pistol.semiauto"]         = "https://via.placeholder.com/256x256.png?text=Semi+Pistol",
                ["pistol.semiauto.a.m15"]   = "https://via.placeholder.com/256x256.png?text=M15",
                ["pistol.prototype17"]      = "https://via.placeholder.com/256x256.png?text=Proto17",
                ["pistol.python"]           = "https://via.placeholder.com/256x256.png?text=Python",
                ["pistol.nailgun"]          = "https://via.placeholder.com/256x256.png?text=Nailgun",
                ["pistol.revolver"]         = "https://via.placeholder.com/256x256.png?text=Revolver",
                ["rifle.ak"]                = "https://cdn.carbonmod.gg/items/rifle.ak.png",
                ["rifle.m39"]               = "https://cdn.carbonmod.gg/items/rifle.m39.png",
                ["rifle.semiauto"]          = "https://via.placeholder.com/256x256.png?text=Semi+Rifle",
                ["rifle.l96"]               = "https://via.placeholder.com/256x256.png?text=L96",
                ["rifle.bolt"]              = "https://via.placeholder.com/256x256.png?text=Bolt",
                ["rifle.lr300"]             = "https://via.placeholder.com/256x256.png?text=LR300",
                ["rifle.sks"]               = "https://via.placeholder.com/256x256.png?text=SKS",
                ["shotgun.pump"]            = "https://via.placeholder.com/256x256.png?text=Pump",
                ["shotgun.m4"]              = "https://via.placeholder.com/256x256.png?text=M4+Shotgun",
                ["shotgun.waterpipe"]       = "https://via.placeholder.com/256x256.png?text=Waterpipe",
                ["shotgun.spas12"]          = "https://via.placeholder.com/256x256.png?text=Spas12",
                ["shotgun.double"]          = "https://via.placeholder.com/256x256.png?text=Double+Barrel",
                ["krieg.shotgun"]           = "https://via.placeholder.com/256x256.png?text=Krieg",
                ["blunderbuss"]             = "https://via.placeholder.com/256x256.png?text=Blunderbuss",
                ["t1_smg"]                  = "https://via.placeholder.com/256x256.png?text=T1+SMG",
                ["rocket.launcher"]         = "https://via.placeholder.com/256x256.png?text=Rocker+Launcher",
                ["rocket.launcher.rpg7"]    = "https://via.placeholder.com/256x256.png?text=RPG7",
                ["grenade.f1"]              = "https://via.placeholder.com/256x256.png?text=F1",
                ["multiplegrenadelauncher"] = "https://via.placeholder.com/256x256.png?text=MGL",
                ["grenade.molotov"]         = "https://via.placeholder.com/256x256.png?text=Molotov",
                ["pistol.water"]            = "https://via.placeholder.com/256x256.png?text=Water+Pistol",
            };
        }
